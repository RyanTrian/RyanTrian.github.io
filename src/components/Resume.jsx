      ...
      <div className="max-w-3xl mx-auto">
        <div className="py-8">
          ...
          <div className="mt-4 text-gray-700">
            ...
            <p>
              ...
              <a
                target="blank"
                href="mailto:mptruong49@gmail.com"
          ...
          <div className="mt-8">
            <h2 className="text-3xl font-bold border-b-2 border-gray-200">
              Summary
            </h2>
            <div className="mt-2 text-gray-700">
            Full Stack Developer with a background in Biology and Oral Health. Specialize in MERN Stack and eager to tackle problems and bring ideas to life collaboratively. Committed to positively impacting the tech industry through innovative solutions.
            </div>
          </div>
        ...
        <div className="py-4">
          ...
          <div className="mt-4">
            ...
            <ul className="list-disc list-inside mt-2 text-gray-700">
              <li>
                ...
                search, and bookmarking. Implemented user reviews and ratings,
                and welcome emails via Nodemailer.
              </li>
              <li>
                <span className="font-bold">Contribution:</span> Database
          ...
          <div className="mt-4">
            <div className="flex flex-row items-center justify-between">
              <div className="text-lg font-bold">
                Marvelite Hub | Comics and Movies Search App
              </div>
              <div className="flex mt-2 md:mt-0">
                <a
