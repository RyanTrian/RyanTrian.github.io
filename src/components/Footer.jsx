    ...
    <>
      ...
      <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
          <div className="max-w-lg sm:mx-auto sm:text-center">
              <img src="https://user-images.githubusercontent.com/82792300/228377517-f4b636da-1c53-407d-8cc5-087db798752d.png" className="w-14 sm:mx-auto" />
              <p className="leading-relaxed mt-2 text-[15px]">
                Feel free to reach out if you want a to build something together, have a question, or just want to connect
                <a aria-label="Email" href="mailto:mptruogn49@gmail.com" className="mx-2 text-blue-500 hover:text-blue-700" target="blank">mptruong49@gmail.com</a>
              </p>
          </div>
